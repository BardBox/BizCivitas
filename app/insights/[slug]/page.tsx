...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!blog) {
    return {
      title: "Blog Post Not Found - BizCivitas Insights",
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <nav className="bg-white border-b border-gray-200">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center space-x-2 py-4 text-sm">
              ...
              <Link href="/insights" className="text-blue-600 hover:text-blue-800">Insights</Link>
              <span className="text-gray-400">/</span>
        ...
        <article className="py-12">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-12 text-center">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Share this insight</h3>
        ...
        <section className="py-16 bg-gray-900">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl font-bold text-white mb-4">Stay Updated with Business Insights</h2>
