...
export const metadata: Metadata = {
  ...
  description:
    "Discover upcoming and past business networking events at BizCivitas. Join industry leaders for professional development, networking opportunities, and strategic business discussions.",
  keywords: [
    "business events",
    "networking events",
