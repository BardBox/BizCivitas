              ...
              <div className="lg:w-1/2">
                ...
                <div className="flex items-center gap-6">
                  <div className="text-3xl font-bold">
                    {membership.price.currency}{membership.price.monthly}/mo
                  </div>
                  <div className="text-lg text-white/80">
                    or {membership.price.currency}{membership.price.yearly}/year
                  </div>
                </div>
              </div>
              <div className="lg:w-1/2">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col lg:flex-row gap-12">
              ...
              <div className="lg:w-2/3">
                {/* Full Description */}
                <div className="mb-12">
                  <h2 className="text-3xl font-bold text-gray-900 mb-6">About {membership.name}</h2>
                  <p className="text-lg text-gray-700 leading-relaxed">{membership.fullDescription}</p>
                </div>
