    ...
    >  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
          ...
          <div className="lg:col-span-1">
            ...
            <h3 className="font-normal text-2xl mb-4 max-w-md leading-tight">
              Turning Visions into Reality, One<br />
              Event at a Time
            </h3>
          ...
          <div className="lg:col-span-1 lg:text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
              ...
              <button className="px-6 py-2 bg-[#FFFFFF] text-[#6E81BD] rounded-md font-medium text-sm hover:bg-gray-100 transition-colors">
                Subscribe
              </button>
            </div>
          </div>
          ...
          <div className="lg:col-span-1 lg:text-right">
            <h3 className="text-lg font-medium mb-4">Get the app</h3>

            <div className="flex flex-col gap-3 lg:items-end">
              <div className="bg-black rounded-lg px-4 py-2 flex items-center gap-3 w-fit">
