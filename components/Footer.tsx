...
const footerLinks = [
  ...
  { name: 'Discover BizCivitas', href: '/discover', title: 'Discover Business Networking with BizCivitas' },
  { name: 'Our Team', href: '/team', title: 'Meet the BizCivitas Team' },
  { name: 'Insights', href: '/insights', title: 'Business Insights and Resources' },
  { name: 'Events', href: '/events', title: 'Business and Networking Events' },
  { name: 'Membership', href: '/memberships', title: 'Join BizCivitas Membership' },
  { name: 'Contact', href: '/contact', title: 'Contact BizCivitas Support' },
  { name: 'Corporate Networking', href: '/corporate-networking', title: 'Corporate Networking Opportunities' },
  { name: 'Entrepreneur Networking', href: '/entrepreneur-networking', title: 'Entrepreneur Networking Events' },
  { name: 'Travel Networking', href: '/travel-networking', title: 'Travel Networking for Professionals' },
  { name: 'Privacy Policy', href: '/privacy', title: 'BizCivitas Privacy Policy' },
  { name: 'Terms & Conditions', href: '/terms', title: 'BizCivitas Terms and Conditions' },
];

const services = [
  { name: 'Corporate Networking', href: '/corporate-networking', title: 'Corporate Networking Services' },
  { name: 'Entrepreneur Networking', href: '/entrepreneur-networking', title: 'Networking for Entrepreneurs' },
  { name: 'Travel Networking', href: '/travel-networking', title: 'Travel Networking Events' },
  { name: 'Business Events', href: '/events', title: 'Professional Business Events' },
  { name: 'Professional Development', href: '/insights', title: 'Professional Development Resources' },
];
    ...
    "@graph": [
      {
        ...
        description: "BizCivitas connects professionals through business networking, corporate events, and travel networking opportunities.",
      },
      {
        "@type": "WebSite",
        url: "https://www.bizcivitas.com",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            ...
            <section className="lg:col-span-1" aria-labelledby="company-info">
              ...
              <h2 id="company-info" className="font-normal text-2xl mb-4 max-w-md leading-tight">
                Turning Business Visions into Reality
              </h2>
              <p className="text-white/90 mb-8 max-w-md leading-relaxed text-sm">
                Empowering professionals with seamless business networking, corporate events, and unforgettable experiences.
              </p>
            </section>

            {/* Newsletter Section */}
            <section className="lg:col-span-1 lg:text-center" aria-labelledby="newsletter">
              <h2 id="newsletter" className="text-lg font-medium mb-4">
                Join Our Business Networking Newsletter
              </h2>
              <form className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto" action="/subscribe" method="POST">
            ...
            <section className="lg:col-span-1 lg:text-right" aria-labelledby="app-download">
              <h2 id="app-download" className="text-lg font-medium mb-4">Download Our App</h2>
              <div className="flex flex-col gap-3 lg:items-end">
                ...
                >
                  ...
                  <div>
                    ...
                    <span className="text-sm font-semibold text-white block">App Store</span>
                  </div>
                </a>
                <a
                ...
                >
                  ...
                  <div>
                    ...
                    <span className="text-sm font-semibold text-white block">Google Play</span>
                  </div>
                </a>
              </div>
            </section>
